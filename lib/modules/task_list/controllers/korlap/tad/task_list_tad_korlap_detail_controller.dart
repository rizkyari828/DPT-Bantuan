...
class DetailTaskListTadKorlapController extends GetxController {
  final ApiRepository apiRepository;
  DetailTaskListTadKorlapController({required this.apiRepository});

  final argm = Get.arguments;
  var detail = ShowTadKorlapTaskData().obs;
  String date = "";
  ...
  void getDetail() async {
    final res = await apiRepository.showTaskListTadKorlap(argm.toString());
    print(res!.data!);
