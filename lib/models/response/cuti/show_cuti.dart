...
ShowCutiResponse showCutiResponseFromJson(String str) => ShowCutiResponse.fromJson(json.decode(str));

String showCutiResponseToJson(ShowCutiResponse data) => json.encode(data.toJson());
...
class ShowCutiResponse {
    ...
    factory ShowCutiResponse.fromJson(Map<String, dynamic> json) => ShowCutiResponse(
