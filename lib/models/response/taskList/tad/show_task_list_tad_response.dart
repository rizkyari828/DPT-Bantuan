...
//
//     final showTaskListTadResponse = showTaskListTadResponseFromJson(jsonString);

import 'dart:convert';

ShowTaskListTadResponse showTaskListTadResponseFromJson(String str) =>
    ShowTaskListTadResponse.fromJson(json.decode(str));

String showTaskListTadResponseToJson(ShowTaskListTadResponse data) =>
    json.encode(data.toJson());

class ShowTaskListTadResponse {
  ShowTaskListTadResponse({
    this.error,
    this.message,
    this.data,
  });
  ...
  bool? error;
  String? message;
  ShowTaskTadData? data;

  factory ShowTaskListTadResponse.fromJson(Map<String, dynamic> json) =>
      ShowTaskListTadResponse(
        error: json["error"] == null ? null : json["error"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null
            ? null
            : ShowTaskTadData.fromJson(json["data"]),
      );
...
class ShowTaskTadData {
  ...
  factory ShowTaskTadData.fromJson(Map<String, dynamic> json) =>
      ShowTaskTadData(
