...
//
//     final showTaskListTadKorlapResponse = showTaskListTadKorlapResponseFromJson(jsonString);

import 'dart:convert';

ShowTaskListTadKorlapResponse showTaskListTadKorlapResponseFromJson(
        String str) =>
    ShowTaskListTadKorlapResponse.fromJson(json.decode(str));

String showTaskListTadKorlapResponseToJson(
        ShowTaskListTadKorlapResponse data) =>
    json.encode(data.toJson());

class ShowTaskListTadKorlapResponse {
  ShowTaskListTadKorlapResponse({
    this.error,
    this.message,
    this.data,
  });
  ...
  bool? error;
  String? message;
  ShowTadKorlapTaskData? data;

  factory ShowTaskListTadKorlapResponse.fromJson(Map<String, dynamic> json) =>
      ShowTaskListTadKorlapResponse(
        error: json["error"] == null ? null : json["error"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null
            ? null
            : ShowTadKorlapTaskData.fromJson(json["data"]),
      );
...
class ShowTadKorlapTaskData {
  ...
  factory ShowTadKorlapTaskData.fromJson(Map<String, dynamic> json) =>
      ShowTadKorlapTaskData(
