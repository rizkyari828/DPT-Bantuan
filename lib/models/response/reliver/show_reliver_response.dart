...
ShowReliverResponse showReliverResponseFromJson(String str) => ShowReliverResponse.fromJson(json.decode(str));

String showReliverResponseToJson(ShowReliverResponse data) => json.encode(data.toJson());
...
class ShowReliverResponse {
    ...
    factory ShowReliverResponse.fromJson(Map<String, dynamic> json) => ShowReliverResponse(
        error: json["error"] == null ? null : json["error"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null ? null : DataShowReliver.fromJson(json["data"]),
    );
...
class DataShowReliver {
    ...
    factory DataShowReliver.fromJson(Map<String, dynamic> json) => DataShowReliver(
        id: json["id"] == null ? null : json["id"],
        code: json["code"] == null ? null : json["code"],
        dateRequest: json["date_request"] == null ? null : DateTime.parse(json["date_request"]),
        dateNeeded: json["date_needed"] == null ? null : DateTime.parse(json["date_needed"]),
        dateEndNeeded: json["date_end_needed"] == null ? null : DateTime.parse(json["date_end_needed"]),
        ...
        dateStartWorkEmployee: json["date_start_work_employee"] == null ? null : DateTime.parse(json["date_start_work_employee"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "date_needed": dateNeeded == null ? null : "${dateNeeded?.year.toString().padLeft(4, '0')}-${dateNeeded?.month.toString().padLeft(2, '0')}-${dateNeeded?.day.toString().padLeft(2, '0')}",
        "date_end_needed": dateEndNeeded == null ? null : "${dateEndNeeded?.year.toString().padLeft(4, '0')}-${dateEndNeeded?.month.toString().padLeft(2, '0')}-${dateEndNeeded?.day.toString().padLeft(2, '0')}",
        ...
        "date_start_work_employee": dateStartWorkEmployee == null ? null : "${dateStartWorkEmployee?.year.toString().padLeft(4, '0')}-${dateStartWorkEmployee?.month.toString().padLeft(2, '0')}-${dateStartWorkEmployee?.day.toString().padLeft(2, '0')}",
